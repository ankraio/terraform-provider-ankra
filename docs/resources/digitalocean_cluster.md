...
page_title: "ankra_digitalocean_cluster Resource - ankra"
subcategory: ""
description: |-
  Provisions a DigitalOcean-backed cluster on the Ankra platform. Provisioning arguments are immutable, so changing one forces replacement.
---

# ankra_digitalocean_cluster (Resource)
...
- `credential_id` (String) DigitalOcean API credential id used to provision the cluster.
- `name` (String) Name of the cluster.
- `region` (String) DigitalOcean region (e.g. `fra1`, `nyc3`, `ams3`).
...
- `worker_size` (String) Droplet size for worker nodes.
